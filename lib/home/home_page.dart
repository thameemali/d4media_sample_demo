    ...
    return Obx(
      () => Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: _homeController.videoListClicked.value
              ? VideoPlayerAppBar(homeController: _homeController)
              : const CustomAppBar(),
        ),
        drawer: const CustomDrawer(),
        floatingActionButton: CustomFAB(
          onTap: () {
            _homeController.viewAllClicked.value=false;
            ...
            _homeController.chewieController.value.videoPlayerController
                .pause();
          },
        ),
              ...
              () => Container(
                ...
                child: _homeController.nothingClicked.value
                    ? _homeController.videoListClicked.value
                        ...
                        : _homeController.viewAllClicked.value
                            ? ViewAllWidget(homeController: _homeController)
